                ...
                <div style={{ minHeight: 100, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    {audioReady ? (
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
                            ...
                            <button onClick={function() { sfx.click(); setShowLeaderboard(true); }} style={{ background: "rgba(20,16,9,0.8)", border: "2px solid #3d2e0f", borderRadius: 8, color: "#5a4a38", padding: "8px 24px", fontSize: 12, cursor: "pointer", letterSpacing: 3, textTransform: "uppercase", fontFamily: "monospace", fontWeight: "bold", transition: "border-color 0.4s, color 0.4s" }}>LEADERBOARD</button>
                        </div>
                    ) : (
