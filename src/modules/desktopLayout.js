                    ...
                    {!activeCustomer && (
                        <div data-fairy-target="scene" onMouseDown={isQTEActive ? onForgeClick : null} style={{ background: "#0f0b06", border: "1px solid #3d2e0f", borderRadius: 10, padding: "12px", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, position: "relative", cursor: isQTEActive ? "pointer" : "default", flex: 1, minHeight: 280, overflow: "hidden" }}>
                            ...
                            <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-end", gap: 4, width: "100%", flex: 1 }}>
                                ...
                                {/* WEAPON SELECT */}
                                {phase === PHASES.SELECT && (<div data-fairy-target="weapon_select_panel" style={{ display: "flex", gap: 12, alignItems: "center", justifyContent: "center", width: "80%" }}>
                                ...
                                {/* MATERIAL SELECT */}
                                {phase === PHASES.SELECT_MAT && (<div data-fairy-target="mat_select_panel" style={{ display: "flex", gap: 12, alignItems: "center", justifyContent: "center", width: "80%" }}>
