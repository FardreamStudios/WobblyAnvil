...
LEGAL_TRANSITIONS[FORGE_PHASES.HEAT]        = [FORGE_PHASES.HAMMER, FORGE_PHASES.FAIRY_RESCUE, FORGE_PHASES.IDLE];
LEGAL_TRANSITIONS[FORGE_PHASES.HAMMER]      = [FORGE_PHASES.SESS_RESULT, FORGE_PHASES.FAIRY_RESCUE, FORGE_PHASES.IDLE];
LEGAL_TRANSITIONS[FORGE_PHASES.SESS_RESULT] = [FORGE_PHASES.HEAT, FORGE_PHASES.QUENCH, FORGE_PHASES.FAIRY_RESCUE, FORGE_PHASES.IDLE];
LEGAL_TRANSITIONS[FORGE_PHASES.QUENCH]      = [FORGE_PHASES.FAIRY_RESCUE, FORGE_PHASES.IDLE];
LEGAL_TRANSITIONS[FORGE_PHASES.FAIRY_RESCUE] = [FORGE_PHASES.SESS_RESULT, FORGE_PHASES.IDLE];
