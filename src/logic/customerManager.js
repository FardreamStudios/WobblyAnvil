// ============================================================
// customerManager.js — Wobbly Anvil Customer Lifecycle Manager
...
//
// INIT:
//   CustomerManager.init(bus, stateProvider, abilityManager);
...
function init(bus, stateProvider, abilityManager, config) {
    if (_initialized) {
        console.warn("[CustomerManager] Already initialized. Call reset() first.");
        return;
    }
